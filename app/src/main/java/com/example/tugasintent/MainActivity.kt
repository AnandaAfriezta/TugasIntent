...
import com.example.tugasintent.MoveForResult.Companion.RESULT_CODE
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.btn_move_with_data -> {
                ...
                moveWithDataIntent.putExtra(MoveActivityWithData.EXTRA_NAME, "Ananda Afriezta.E.K")
            ...
            R.id.btn_move_with_object -> {
                val person = Person(name = "Atta", email = "ananda.afriezta@gmail.com", city = "Tuban")
